...
static mqKeyboardKey fxKeys[] = {
    ...
    { ",",     { 260, 150, 55, 24 },  5, 2, -1 },
    { "->",    { 320, 150, 55, 24 },  5, 1, -1 },
    { "7",     {  20, 180, 67, 24 },  4, 6, MQ_KEY_7 },
    { "8",     {  92, 180, 67, 24 },  4, 5, MQ_KEY_8 },
    { "9",     { 164, 180, 67, 24 },  4, 4, MQ_KEY_9 },
    { "DEL",   { 236, 180, 67, 24 },  4, 3, -1 },
    { "AC/ON", { 308, 180, 67, 24 },  0, 0, -1 }, // onKey
    { "4",     {  20, 210, 67, 24 },  3, 6, MQ_KEY_4 },
    { "5",     {  92, 210, 67, 24 },  3, 5, MQ_KEY_5 },
    { "6",     { 164, 210, 67, 24 },  3, 4, MQ_KEY_6 },
    { "×",     { 236, 210, 67, 24 },  3, 3, -1 },
    { "÷",     { 308, 210, 67, 24 },  3, 2, -1 },
    { "1",     {  20, 240, 67, 24 },  2, 6, MQ_KEY_1 },
    { "2",     {  92, 240, 67, 24 },  2, 5, MQ_KEY_2 },
    { "3",     { 164, 240, 67, 24 },  2, 4, MQ_KEY_3 },
    { "+",     { 236, 240, 67, 24 },  2, 3, -1 },
    { "-",     { 308, 240, 67, 24 },  2, 2, -1 },
    { "0",     {  20, 270, 67, 24 },  1, 6, MQ_KEY_0 },
    { ".",     {  92, 270, 67, 24 },  1, 5, -1 },
